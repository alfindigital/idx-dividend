  ...
  return (
    <div className="w-full sm:hidden">
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-line bg-surface py-2 text-sm font-medium text-fg"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute inset-x-0 bottom-0 max-h-[85vh] overflow-auto rounded-t-2xl border-t border-line bg-bg p-4 pb-[calc(env(safe-area-inset-bottom)+1rem)]">
            ...
            <div className="mt-4 flex gap-2">
              <button
                ...
                className="flex-1 rounded-lg border border-line bg-surface py-2 text-sm font-medium text-fg"
              >
                Reset
              </button>
              <button
                ...
                className="flex-1 rounded-lg bg-indigo-600 py-2 text-sm font-semibold text-white shadow-glow"
              >
                Terapkan
              </button>
            </div>
